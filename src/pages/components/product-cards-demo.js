// ============================================================================
// SMB Website - Product Cards Interactive Demo
// JavaScript for product cards demonstration page
// ============================================================================
...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        console.log('SMB Product Cards Demo initialized');
    });
    ...
    function toggleFavorite(button) {
        const isActive = button.classList.contains('product-card__favorite--active');
        toggleFavoriteState(button, !isActive);
    ...
    function selectColor(button, color) {
        ...
        button.classList.add('product-card__color--selected');
        
        console.log(`Interactive demo: Selected color ${color}`);
    }

    function toggleFavorites() {
        const favoriteButtons = document.querySelectorAll('.product-card__favorite:not([disabled])');
        ...
        console.log('All favorites toggled');
    }
    ...
    function simulateLoading() {
        ...
        // Add loading state
        demoCard.classList.add('product-card--loading');
        
        // Disable interactions
        const interactiveElements = demoCard.querySelectorAll('button, a');
        ...
        setTimeout(() => {
            demoCard.classList.remove('product-card--loading');
    ...
    function toggleAvailability() {
        ...
        const isUnavailable = demoCard.classList.contains('product-card--unavailable');
        
        if (isUnavailable) {
            demoCard.classList.remove('product-card--unavailable');
            ...
            console.log('Product made available');
        } else {
            demoCard.classList.add('product-card--unavailable');
            ...
            console.log('Product made unavailable');
        }
    }
    ...
    function logPerformance() {
        if (window.performance && window.performance.mark) {
            window.performance.mark('product-cards-demo-loaded');
            
            console.log('Product Cards Demo Performance:', {
                loadTime: window.performance.now(),
                cardsCount: document.querySelectorAll('.product-card').length,
                interactiveElementsCount: document.querySelectorAll('.product-card button, .product-card a').length
            });
        }
    }
